...
module.exports.run = async ({ api, event }) => {
  ...
  if (diffDays === 1) {
    const tomorrowMessage = `👉 Admin ARIYAN KHAN এর জন্মদিন আগামীকাল!
...
╟──────────────────────
║ 📘 Facebook :
║ www.facebook.com/61590366007318
║ 💬 Messenger :
║ m.me/61590366007318
║ 📱 WhatsApp :
║ https://wa.me/+966572373693
╚══════════════════════╝`;
...
╚════════════════════╝`;
  ...
  const url = "https://graph.facebook.com/61590366007318/picture?height=720&width=720";
