...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
   "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস আরিয়ানরে হাঙ্গা করো😶👻😘",
    ...
    "😍": "ইমোজি দিয়ে লাভ নাই 😒যাও মুড়ি খাও😘🐸🤣👍⛏️",
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞IP-ARIYAN ☜\nFacebook: https://www.facebook.com/profile.php?id=61590366007318\nWhatsApp: +966572373693",
    "admin": "He is IP-ARIYAN  তাকে সবাই Admin ARIYAN হিসেবে চিনে😘☺️",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস আরিয়ানরে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    ...
    "ami IP-ARIYAN ": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌IP-ARYAN💖",
